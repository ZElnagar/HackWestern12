      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        {!isDailyDone && (
          <div 
            ...
            className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl shadow-lg p-8 border-2 border-orange-200 hover:border-orange-400 cursor-pointer transition-all transform hover:-translate-y-1 group relative overflow-hidden"
          >
            ...
            <div className="bg-orange-200 w-16 h-16 rounded-full flex items-center justify-center mb-6 group-hover:bg-orange-300 transition-colors">
              <Calendar className="text-orange-600" size={32} />
            </div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">Daily Check-in</h3>
            <p className="text-slate-600 mb-6">
              A quick daily face scan to track your progress and update your vitals.
            </p>
            <div className="flex items-center text-orange-700 font-semibold group-hover:gap-2 transition-all">
        ...
        >
          ...
          <h3 className="text-xl font-bold text-slate-900 mb-3">Comprehensive Scan</h3>
        ...
        <div
          ...
          className="bg-white rounded-2xl shadow-lg p-8 border-2 border-blue-100 hover:border-blue-500 cursor-pointer transition-all transform hover:-translate-y-1 group relative overflow-hidden"
        >
          ...
          <h3 className="text-xl font-bold text-slate-900 mb-3">Hand Scan</h3>
          <p className="text-slate-500 mb-6">
