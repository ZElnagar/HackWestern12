...
const FACE_STEPS = [
  ...
  },
  {
    ...
    label: "Left Profile",
    instruction:
      "Turn your head slowly to the RIGHT (showing your left profile).",
  },
  {
    id: "right",
    label: "Right Profile",
    instruction:
      "Turn your head slowly to the LEFT (showing your right profile).",
  },
];
...
const CameraCapture: React.FC<CameraCaptureProps> = ({
  ...
  const [captures, setCaptures] = useState<ImageCaptureSet>({
    front: null,
    left: null,
    right: null,
  });
  ...
  const startCamera = useCallback(async () => {
    try {
      ...
      setError(
        "Unable to access camera. Please ensure permissions are granted and another app is not using it."
      );
    }
  }, []);
